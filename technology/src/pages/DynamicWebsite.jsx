...
function DynamicWebsite() {
    return (
        <div className='container my-10'>
            ...
            <h1 className="text-2xl font-normal font-bold leading-tight mx-40"><b>DYNAMIC WEBSITE DESIGNING</b></h1>
            ...
            <h1 className="text-2xl font-normal font-bold leading-tight mx-40"><b>Advantage of Dynamic Website Designing</b></h1>
            <hr className="border-black mx-40" />
            <div className='pl-7'>
                <ul className='mx-40'>
            ...
            <div class="max-w-md mx-auto bg-blue-100 border border-gray-400 rounded-lg shadow-md p-6 mb-4 hover:border-blue-500 hover:shadow-2xl transform hover:scale-105 transition duration-300 ease-in-out">
                ...
                <p class="text-gray-700">The price of dynamic website is depend on the requirement. The range of dynamic website is starts from Rs. 15,000.</p>
            </div>
        </div>
    )
}
